...
print(controller.create_race("Test Race"))
print(controller.create_car("SportsCar", "Porsche F1", 590))
print(controller.add_car_to_driver("Jack", "SportsCar"))
print(controller.add_driver_to_race("Test Race", "John"))
print(controller.add_driver_to_race("Test Race", "Jack"))
print(controller.add_driver_to_race("Test Race", "Kelly"))
print(controller.add_driver_to_race("Test Race", "Peter"))
print(controller.start_race("Test Race"))
